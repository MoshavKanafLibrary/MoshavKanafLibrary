        ...
        <div className="p-3 sm:p-4">
          ...
          {expandBooks && (
            <ul className="flex flex-col space-y-1 sm:space-y-2 mt-1 sm:mt-2">
              ...
              <li className="flex items-center p-2 sm:p-2 hover:bg-bg-hover hover:text-bg-header-custom rounded cursor-pointer" onClick={() => handleNavigate("/searchbook", { mode: 1 })}>
