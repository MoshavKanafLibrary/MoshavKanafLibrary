...
const AdminSidebar = ({ isVisible, toggleSidebar }) => {
  ...
  return (
    <>
      ...
      <div
        className={`fixed top-16 sm:top-[64px] right-0 w-56 sm:w-72 h-[calc(100%-4rem)] sm:h-[calc(100%-64px)] bg-[#E7DBCB] text-[#7C382A] flex flex-col rounded-lg transition-transform duration-300 transform ${
