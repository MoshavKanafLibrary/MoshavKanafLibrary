...
const BookDetailPage = () => {
  ...
  return (
    <div className="bg-[#4B0000] min-h-screen py-12" dir="rtl">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          {/* Book Details Section */}
          <div className="lg:col-span-2 bg-[#F1E0DC] shadow-lg rounded-lg p-8 flex flex-col md:flex-row h-[600px]">
            ...
            <div className="md:w-1/2 md:pl-12 mt-6 md:mt-0 overflow-y-auto">
              ...
              <button
                className={user ? "bg-[#7C382A] text-[#F1E0DC] hover:bg-[#4B0000] font-bold py-3 px-6 rounded focus:outline-none focus:shadow-outline" : "bg-[#7C382A] text-[#F1E0DC] font-bold py-3 px-6 rounded opacity-50 cursor-not-allowed"}
          ...
          {/* Reviews Section */}
          <div className="lg:col-span-1 bg-[#F1E0DC] shadow-lg rounded-lg p-6 max-h-[600px] overflow-y-auto">
            ...
            <div className="mb-6">
              {user ? (
                <div className="flex flex-col space-y-6">
                  ...
                  />
                  <button
                    className="bg-[#4B0000] text-[#F1E0DC] py-3 px-6 rounded hover:bg-[#7C382A] focus:outline-none"
              ...
              <div className="space-y-6">
                {reviews.map((review, index) => (
                  <div key={index} className="bg-[#7C382A] p-4 rounded-lg shadow-md">
                    <p className="font-semibold text-[#F1E0DC]">{review.firstName} {review.lastName}</p>
                    <p className="text-[#F1E0DC]">{review.review}</p>
                    <p className="text-xs text-[#F1E0DC] mt-2">
        ...
        <div className="bg-[#F1E0DC] shadow-lg rounded-lg p-8 mt-12">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
                  {books.map((book, index) => (
                    ...
                    >
                      ...
                      <h2 className="text-xl font-semibold text-[#F1E0DC]">{book.title}</h2>
                      <p className="text-[#F1E0DC]">מאת {book.author}</p>
                    </div>
                  ))}
                </div>
              )}
